...
function Cart() {
  ...
  useEffect(()=>{
    getTotal()
  },[cart,setSubTotal,dc,gst,discount])
                    ...
                    <ul className="list-group">
                      ...
                      <ul className="list-group">
                        <li className="list-group-item mt-2 mb-2">
                          <strong>Total</strong>
                            <span className="text-success float-end"> = &#8377; {Math.round((subTotal + dc) - (Math.round(subTotal*(discount/100))))}
                            </span>
                      </li>
                    </ul>
                  </div>
                  <div className="cart-footer d-grid">
