          ...
          <div className="card">
            <div className="card-body">
              ...
              <div id="pro" className='carousel slide' data-bs-ride="carousel">
                ...
                <button
                 className="carousel-control-prev" type='button' data-bs-target='#pro' data-bs-slide='prev'>
                  <span className="carousel-control-prev-icon" aria-hidden="true"/>
                  <span className="visually-hidden">Previous</span>
                 </button>

                 <button
                 className="carousel-control-next" type='button' data-bs-target='#pro' data-bs-slide='next'>
